...
/**
 * <p>
 * The <code>DuplicateFilter</code> drops duplicate results. Results are considered equal if
 * <code>StringUtils.equalsCommonNorm()</code> is true for the answer strings. In this case the
 * result with the higher score is kept and its score is incremented by the score of the other
 * result.
 * </p>
 * 
 * <p>
 * This class extends the class <code>Filter</code>.
 * </p>
 * 
...
public class DuplicateFilter extends Filter {
  ...
  /**
   * Filters duplicate results and increments the scores of the remaining results by the scores of
   * the dropped results.
   * 
   * @param results
   *          array of <code>Result</code> objects
