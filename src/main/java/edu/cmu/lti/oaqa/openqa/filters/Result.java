...
/**
 * <p>
 * A <code>Result</code> is a data structure representing a result returned by the QA engine.
 * </p>
 * 
 * <p>
 ...
 * <li>hit position at which the answer was returned by a search engine (optional)</li>
 * <li>flag indicating whether the answer was judged correct (optional)</li>
 * <li>other elements depending on the granularity of the answer string (e.g. sentence, factoid)</li>
 * </ul>
 * </p>
 * 
 * <p>
 * This class implements the interfaces <code>Comparable</code> and <code>Serializable</code>. Note:
 * it has a natural ordering that is inconsistent with <code>equals()</code>.
 * </p>
 * 
...
public class Result implements Comparable<Result>, Serializable {
  ...
  /**
   * If this is a sentence-level answer, named entities extracted from the sentence and their types
   * (optional).
   */
  ...
  /**
   * If this is a factoid answer, a sentence in the supporting document the answer was extracted
   * from (optional).
   */
  ...
  /**
   * Creates a <code>Result</code> object and sets the answer string and the <code>Query</code> that
   * was used to obtain the answer.
   * 
   * @param answer
   *          answer string
   * @param query
  ...
  /**
   * Creates a <code>Result</code> object and sets the answer string, the <code>Query</code> that
   * was used to obtain the answer and the ID of a document that contains it.
   * 
   * @param answer
   *          answer string
   * @param query
  ...
  /**
   * Creates a <code>Result</code> object and sets the answer string, the <code>Query</code> that
   * was used to obtain the answer, the ID of a document that contains it and the hit position.
   * 
   * @param answer
   *          answer string
   * @param query
   ...
   * 
   * @param result
   *          the result to be compared
   * @return a negative integer, zero or a positive integer as this result is less than, equal to or
   *         greater than the specified result
   */
  ...
  /**
   * Indicates whether an other result is equal to this one. Two results are considered equal if the
   * answer strings are equal.
   * 
   * @param o
  ...
  /**
   * Returns the <code>Query</code> that was used to obtain this result, or <code>null</code> if it
   * is not set.
   * 
  ...
  /**
   * Returns the ID of a document that contains the answer or <code>null</code> if it is not set.
   * 
  ...
  /**
   * Returns the ID of the document in the search engine cache or <code>null</code> if it is not
   * set.
   * 
   ...
   * 
   * @param predicate
   *          predicate extracted from a sentence
   */
   ...
   * 
   * @param sourceName
   *          the name of the source of the score
   * @param score
   ...
   * 
   * @param sourceName
   *          the name of the source who set the required score
